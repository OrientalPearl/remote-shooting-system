            ...
            <div class="row">
            	<div class="col-md-12">
                    <div class="box box-warning">
                        <!-- /.box-header -->
                        <div class="box-body">
							<form method="POST" action="<?php echo U('Admin/System/sysoplog');?>" id="posts">
								<div class="portlet-body">
                                   <div class="row">
                                        <div class="col-md-12 margin">
	                                        <input type="text" name="search_uname" 
	                                     		placeholder="用户名" value="<?php echo I('get.search_uname');?>">
                                   ...
                                   <div class="row">
                                        <div class="col-md-3 margin">
                                            ...
                                            <select style="width:60px"
                                                    ...
                                                    size="1"
                                                    name="mlink2">
													<option value="/cms/index.php?m=admin&c=system&a=sysoplog&page=20" <?php if ($page == 20) {echo selected;} ?> >20</option>
	                                                <option value="/cms/index.php?m=admin&c=system&a=sysoplog&page=50" <?php if ($page == 50) {echo selected;} ?> >50</option>
	                                                <option value="/cms/index.php?m=admin&c=system&a=sysoplog&page=100" <?php if ($page == 100) {echo selected;} ?> >100</option>
	                                                <option value="/cms/index.php?m=admin&c=system&a=sysoplog&page=200" <?php if ($page == 200) {echo selected;} ?> >200</option>
                                            </select>
											<label>条</label>
                                        </div>
										<div class="col-md-3 margin">
